...
AAR_PROJECT_DEPENDENCY = "implementation 'org.cachy:google-webrtc:1.0.+'"
AAR_PROJECT_VERSION_DEPENDENCY = "implementation 'org.cachy:google-webrtc:%s'"
...
def _UploadFile(user, password, filename, version, target_file):
    ...
    # Example:
    # https://api.bintray.com/content/google/webrtc/google-webrtc/1.0.19742/org/cachy/google-webrtc/1.0.19742/google-webrtc-1.0.19742.aar
