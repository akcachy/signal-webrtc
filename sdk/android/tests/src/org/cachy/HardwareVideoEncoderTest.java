...
import org.cachy.EncodedImage;
import org.cachy.EncodedImage.FrameType;
import org.cachy.FakeMediaCodecWrapper.State;
import org.cachy.VideoCodecStatus;
import org.cachy.VideoEncoder;
import org.cachy.VideoEncoder.CodecSpecificInfo;
import org.cachy.VideoEncoder.EncodeInfo;
import org.cachy.VideoEncoder.Settings;
import org.cachy.VideoFrame;
import org.cachy.VideoFrame.Buffer;
import org.cachy.VideoFrame.I420Buffer;
  ...
  private class TestEncoderBuilder {
    ...
    public TestEncoder build() {
      return new TestEncoder((String name)
          ...
          "org.cachy.testencoder", codecType,
